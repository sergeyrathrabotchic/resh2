...
///////////////////////////////////////////////////////////////////// 
    ...
    for($i3=0;$i3<count($arr2);$i3++){
       // $i3=0;
        ...
        for( $i1=0, $a =$arr2[$i3][0], $proverka = 1 ; $i1<$arr2[$i3][0] && $proverka == 1 /*&& 1<$arr2[$i3][0]*/; $i1++ ){
            ...
            if ( $a == $arr4[$i1][0]){
                ...
                $b = $arr2[$i3][0]-($i2+1);
                unset($arr2[$i3][1][$b]);
                $arr2[$i3][1] = array_values($arr2[$i3][1]);
                }
                $arr2[$i3][0]=$arr2[$i3][0]-$a;
                $arr4 = array();
        ...
        for ($i9 = 0, $a="нет"; $i9 <count($arr5) && $a=="нет";$i9++){
            if($i9 == 0){
                $a = p($arr5);
            } else if ($i9 > 0 && $i9 < (count($arr5)-1)){
                $a = pp($arr5,$i9);
            } else {
                $a = ppp($arr5,$i9);
            }
